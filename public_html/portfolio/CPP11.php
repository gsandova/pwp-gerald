...
$s = $hl->highlight("cpp", file_get_contents("../documentation/binaryCPP.h"));
$t = $hl->highlight("cpp", file_get_contents("../documentation/CPPOutput.txt"));
