...
// Highlight some code.
$r = $hl->highlight("c", file_get_contents("../documentation/binary.c"));
$s = $hl->highlight("c", file_get_contents("../documentation/binary.h"));
$t = $hl->highlight("c", file_get_contents("../documentation/COutput.txt"));
...
<body class="sfooter">
	<div class="sfooter-content">
		...
		<div class="container pad">
			...
			<div class="well">
				<h2 align="center">C programming language (C99)</h2>
				<p>This is the ANSI C version
