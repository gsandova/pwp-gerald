...
// Highlight some code.
$r = $hl->highlight("python", file_get_contents("../documentation/binary.py"));
$s = $hl->highlight("python", file_get_contents("../documentation/function.py"));
$t = $hl->highlight("cpp", file_get_contents("../documentation/PythonOutput.txt"));
